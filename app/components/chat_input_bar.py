        ...
        rx.el.form(
            rx.el.div(
                rx.el.button(
                    ...
                    type="button",
                    class_name="p-2 bg-[#40414F] hover:bg-[#50515f] rounded-md h-10 w-10 flex items-center justify-center",
                ),
                rx.el.button(
                ...
                rx.el.textarea(
                    ...
                    class_name="flex-grow bg-transparent text-neutral-200 placeholder-neutral-500 focus:outline-none resize-none px-3 text-base w-full",
                    rows=1,
                    auto_height=True,
                    max_height="25vh",
                ...
                rx.el.button(
                    ...
                    type="submit",
                    class_name="p-2 bg-[#E97055] hover:bg-[#d3654c] rounded-md aspect-square h-10 w-10 flex items-center justify-center",
                    is_disabled=ChatState.is_streaming,
                ),
                class_name="bg-[#2A2B2E] rounded-xl shadow-lg w-full flex items-center p-2 gap-2",
            ),
